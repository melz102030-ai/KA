...
> **يعمل بالكامل على الخطة المجانية (Spark).** لا تُفعّل Blaze. العمليات تتم من
> العميل على Firestore محميّةً بالقواعد. Cloud Functions مسار ترقية اختياري فقط.

## المسار المجاني (الافتراضي)
